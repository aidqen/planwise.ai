...
export function ScheduleSidebar({ schedule, setSchedule, onScheduleEdit, setIsLoading, isLoading, multiStepForm }) {
    ...
    return (
        <>
            {/* Desktop Sidebar */}
            <Card className="hidden md:block overflow-y-auto overflow-x-hidden relative px-0 pt-16 mx-auto max-w-md h-full min-h-screen max-h-screen bg-transparent transition-all duration-200 w-[25em]"
                style={{ width: '40em' }}>
                <SidebarContent />
            </Card>
