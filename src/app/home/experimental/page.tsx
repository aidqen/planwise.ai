...
import { CustomPromptInput } from "@/components/custom/HomepageChat/CustomPromptInput"
    ...
    return <div className="relative w-full h-full flex flex-col justify-center items-center dark:bg-[#161618] bg-white text-black">
        ...
        <div className="w-full max-w-[680px] mt-[100px] flex flex-col items-center gap-2">
            <div className="flex flex-col items-center text-black dark:text-white">
                ...
                <p className="text-lg text-gray-500 dark:text-gray-300">How can I help you?</p>
            </div>
            <CustomPromptInput setInput={setInput} input={input} />
            <div className="flex flex-row items-center justify-between w-full mt-4">
                {quickActions.map((action, index: number) => (
                    <motion.button
                        ...
                        className="rounded-full flex flex-row gap-1 dark:text-stone-200 text-stone-600 items-center justify-center dark:bg-[#222124] dark:hover:bg-[#292929] bg-gray-100  px-2 py-1.5 text-xs text-start whitespace-nowrap transition-colors">
    ...
    return (
        <div className="w-full absolute flex flex-row gap-4 items-center justify-end px-4 top-0 h-10">
            <button
                ...
                className="px-2 h-7 flex flex-row items-center gap-1 dark:bg-[#222124] dark:hover:bg-[#292929] bg-gray-100 hover:bg-gray-200 transition-colors duration-200 rounded-lg text-[0.8rem] text-stone-600 dark:text-stone-300"
            >
                <Palette className="h-4 w-4" />
                Appearance
            </button>
            <button className="rounded-md h-7 w-7 flex justify-center items-center cursor-pointer hover:bg-gray-200 dark:hover:bg-[#292929] transition-color duration-200">
