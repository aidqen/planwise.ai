  ...
  return (
    <div className="grid grid-cols-[57%_43%] max-sm:grid-cols-1 p-[0.35em] h-screen w-screen bg-white">
      <div className="flex flex-col items-center justify-center col-start-1">
        <h1 className="font-bold text-black/80 text-6xl max-sm:text-4xl mb-20 text-center">Welcome back to <br/> Planwise AI 🍀</h1>
        <div className="flex flex-col w-[23rem] max-sm:w-[70%] justify-center items-center">
          ...
          <div className="flex flex-row items-center justify-center gap-3 rounded-full shadow-md w-full border-black/20 border max-sm:py-3 py-4 ">
          ...
          <div className="mt-7 mb-12 flex flex-row items-center w-full justify-between">
            <div className="flex flex-row items-center gap-2">
                ...
                <label htmlFor="remember" className='text-black/80 font-semibold text-xs max-sm:text-[0.7em]'>Remember for 30 days</label>
            </div>
            <p className="text-black/50 font-semibold text-xs max-sm:text-[0.7em]">Forgot password?</p>
          </div>
          <button className="bg-green-500 hover:bg-green-600 shadow-md transition-colors w-full text-sm text-white font-bold py-4 rounded-full mb-5">Log in</button>
          <p className='text-black/50 text-xs'>Don't have an account? <span className='text-black font-semibold'>Sign Up</span></p>
        </div>
      </div>
