...
const faqsList = [
    ...
    {
        q: "Can I sell my digital products using Planwise?",
        a: "Of course you can market and sell your digital products and subscriptions with Planwise to drive higher conversions and save big on fees.",
    }
]
